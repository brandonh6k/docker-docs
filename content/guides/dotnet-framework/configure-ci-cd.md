---
title: Configure CI/CD for your .NET Framework application
linkTitle: Configure CI/CD
weight: 40
keywords: .net framework, CI/CD, windows containers
description: Learn how to Configure CI/CD for your .NET Framework application
aliases:
  - /language/dotnet-framework/configure-ci-cd/
  - /guides/language/dotnet-framework/configure-ci-cd/
---

## Prerequisites

Complete all the previous sections of this guide, starting with [Containerize a .NET Framework application](containerize.md). You must have a [GitHub](https://github.com/signup) account and a [Docker](https://hub.docker.com/signup) account to complete this section.
...
Note: Building .NET Framework applications requires Windows runners in GitHub Actions.
