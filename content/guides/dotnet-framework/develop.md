---
title: Use containers for .NET Framework development
linkTitle: Develop your app
weight: 20
keywords: .net framework, development, windows containers
description: Learn how to develop your .NET Framework application locally using containers.
aliases:
  - /language/dotnet-framework/develop/
  - /guides/language/dotnet-framework/develop/
---

## Prerequisites

Complete [Containerize a .NET Framework application](containerize.md).
...
- Creating a development container that contains the .NET Framework SDK tools and dependencies

## Update the application

This section uses a different branch of the `docker-dotnet-framework-sample` repository
that contains an updated .NET Framework application. The updated application is on the
`add-db` branch of the repository you cloned in [Containerize a .NET Framework
application](containerize.md).

To get the updated code, you need to checkout the `add-db` branch. For the changes you made in [Containerize a .NET Framework application](containerize.md), for this section, you can stash them. In a terminal, run the following commands in the `docker-dotnet-framework-sample` directory.
...
In the `add-db` branch, only the .NET Framework application has been updated. None of the Docker assets have been updated yet.

You should now have the following in your `docker-dotnet-framework-sample` directory.
...
Open `docker-dotnet-framework-sample/src/appsettings.json` in an IDE or text editor. You'll
...
In the `docker-dotnet-framework-sample` directory, create a new directory named `db` and
...
Open `docker-dotnet-framework-sample/src/Pages/Index.cshtml` in an IDE or text editor and update the student name text on line 13 from `Student name is` to `Student name:`.
